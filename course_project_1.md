...
![Average number of steps by 5 min. interval](course_project_1_files/figure-html/time serie max-1.png)
...
![](course_project_1_files/figure-html/histogram no NA-1.png)<!-- -->
...
![](course_project_1_files/figure-html/unnamed-chunk-1-1.png)<!-- -->
```That's all```
